import type { CruiseTip } from "./types";

export const cruiseTips: CruiseTip[] = [
  {
  ...
  },
  {
    ...
    excerpt: "Tender ports like Grand Cayman require extra planning and weather backup plans.",
    content:
  ...
  },
  {
    ...
    excerpt: "When 3+ ships are in port, beaches and popular sites get crowded fast.",
    content:
  ...
  {
    title: "Pack Smart for Port Days",
    excerpt: "The right gear makes Caribbean shore excursions more comfortable and enjoyable.",
    content:
  ...
  {
    title: "Maximize Short Port Days",
    excerpt: "Half-day ports require ruthless prioritization. Here's how to make every hour count.",
    content:
