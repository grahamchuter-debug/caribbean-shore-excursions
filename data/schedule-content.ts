...
export const SCHEDULE_FAQS: FAQ[] = [
  {
    ...
    answer:
      "Each row lists the date a ship is due in port, the vessel and cruise line, published arrival and departure times, estimated time in port, and any notes such as tender operations. Use the month navigation to browse January through December 2026.",
  },
  {
