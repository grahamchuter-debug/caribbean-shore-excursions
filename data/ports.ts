...
export const ports: Port[] = [
  {
    ...
    topAttractions: [
      { name: "Magens Bay", description: "Iconic horseshoe beach with calm waters and facilities.", distance: "15 min by taxi", guideHref: "/magens-bay-st-thomas" },
      { name: "Charlotte Amalie", description: "Historic capital with colonial architecture and shopping.", distance: "5-10 min walk", guideHref: "/charlotte-amalie-st-thomas" },
  ...
  },
  {
    ...
    tagline: "Sloth sanctuaries, rainforest adventures, and authentic Caribbean Costa Rica",
    overview:
    ...
    portInfo: {
      ...
      walkingDistance: "Limited tourism near pier; excursions recommended",
      tenderRequired: false,
      currency: "Costa Rican Colón (CRC), USD widely accepted",
      language: "Spanish (English widely spoken on excursions)",
      timeZone: "Central Standard Time (CST, no daylight saving)",
      safetyNotes: "Use organized excursions with licensed operators. Downtown Limón has limited independent cruise tourism infrastructure.",
    },
    passengerTips: [
      "Rainforest tours dominate here; pack insect repellent and light rain gear",
      "Cahuita snorkel requires a 45-minute coach each way, plan for a half-day minimum",
      "Sloth sanctuary tours sell out on busy Panama Canal sailing weeks",
      "Bring cash for local vendors and optional sanctuary donations",
      "Veragua and zip-line adventures need moderate fitness and closed-toe shoes",
    ],
    topAttractions: [
      { name: "Sloth & Wildlife Sanctuaries", description: "Rescue centers with sloths, monkeys, and tropical birds.", distance: "30-45 min by coach" },
      { name: "Veragua Rainforest Park", description: "Aerial tram, zip-lines, and waterfall trails in primary forest.", distance: "45 min by coach" },
    ...
    highlights: ["Sloth sanctuaries", "Rainforest adventures", "Caribbean Costa Rica", "Direct pier docking"],
    imageAlt: "Sloth in Costa Rican rainforest near Puerto Limón",
  },
  {
    slug: "puerto-plata",
    name: "Puerto Plata",
