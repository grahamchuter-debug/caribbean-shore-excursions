...
export const scheduleYearHubContent: Record<ScheduleYear, ScheduleYearHubContent> = {
  2026: {
    ...
    intro:
      "This is the master 2026 schedule hub for the Caribbean's top ten cruise ports. Select a port below to open its dedicated 2026 monthly table with ship names, cruise lines, arrival and departure times, and time in port. Verified rows are imported from monthly source data; months still awaiting import show a clear placeholder.",
    topPortsIntro:
  ...
  2027: {
    ...
    intro:
      "This is the master 2027 schedule hub for the Caribbean's top ten cruise ports. Select a port below to open its dedicated 2027 monthly table with ship names, cruise lines, arrival and departure times, and time in port. St. Thomas and Ocho Rios currently have verified 2027 data; other ports update as imports are added.",
    topPortsIntro:
...
export function getScheduleYearHubContent(year: ScheduleYear): ScheduleYearHubContent {
  return scheduleYearHubContent[year];
}
